...
def fetchPly(path):
    ...
    return SemanticPointCloud(points=positions, colors=colors, normals=normals)
...
def storeSemanticPly(path, xyz, semantic):
    # Define the dtype for the structured array
    dtype = [('x', 'f4'), ('y', 'f4'), ('z', 'f4'),
             ('nx', 'f4'), ('ny', 'f4'), ('nz', 'f4'),
             ('red', 'u1'), ('green', 'u1'), ('blue', 'u1')]
